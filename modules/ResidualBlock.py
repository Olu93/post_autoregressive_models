...
class ResidualBlockModule(torch.nn.Module):
    def __init__(self, in_emb_size, out_emb_size, kernel_size, stride=1, dilation=1):
        ...
        self.temporal_conv = TemporalBlockModule(
...
if __name__ == '__main__':
    ...
    # print(input.shape)
    module = ResidualBlockModule(in_emb_size=n_channels, out_emb_size=n_channels, kernel_size=kernel_size, dilation=1)
    out = module(input)
    print(out.shape)